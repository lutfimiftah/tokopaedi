...
const Home = () => {
  ...
  const showPrevCategory = () => {
    setCategoryIndex(
      (prevIndex) =>
        (prevIndex - 1 + categoryImages.length) % categoryImages.length
    );
  };
    ...
    <>
      ...
      >
        <div className="flex items-center justify-between w-full px-4">
          ...
          <div className="flex items-center justify-end">
            {/* Tombol Login */}
            <button
              className="border border-green-500 w-20 h-10 rounded-lg text-green-500 font-semibold"
            ...
            {/* Tombol Register */}
            <button
              className="bg-green-500 rounded-lg w-20 h-10 text-white font-semibold ml-2"
        ...
        {/* Tambahan daftar produk populer */}
        <div className="w-full flex justify-center py-1">
          {[
            ...
            <p
              key={index}
              className="text-sm text-slate-400 px-1 hover:text-green-600 cursor-pointer"
            >
              {item}
            </p>
          ))}
          ...
          <div className="relative flex overflow-hidden">
            ...
            >
              {promoImages.map((src, i) => (
                <div
                  key={i}
                  className="w-full rounded-lg shadow-lg flex-shrink-0"
                >
            ...
            <button
              ...
              onClick={() =>
                setPromoIndex(
                  (prevIndex) =>
                    (prevIndex - 1 + promoImages.length) % promoImages.length
                )
              }
            >
              <svg
            ...
            <button
              ...
              onClick={() =>
                setPromoIndex(
                  (prevIndex) => (prevIndex + 1) % promoImages.length
                )
              }
            >
              <svg
          ...
          <div className="my-5 grid grid-cols-6 gap-2">
                ...
                >
                  <style
                    ...
                    dangerouslySetInnerHTML={{
                      __html:
                        ".st0{clip-path:url(#SVGID_2_);} .st1{fill:#FFD401;}",
                    }}
                  />
                  <g>
                    <g>
            ...
            <div className="h-80 w-44 items-center rounded-lg shadow-lg flex-wrap">
              ...
              <p className="text-sm px-2 line-through">
                RP.200.000{" "}
                <span className="absolute px-1 text-red-600">89,5%</span>
              </p>
              <p className="flex text-slate-400 m-2">
                <img src="src/img/logo/centangBiru.png" alt="#" width={25} />
                Jakarta Selatan
            ...
            <div className="h-80 w-44 items-center rounded-lg shadow-lg flex-wrap">
              ...
              <p className="text-sm px-2 line-through">
                RP.100.000{" "}
                <span className="absolute px-1 text-red-600">75%</span>
              </p>
              <p className="flex text-slate-400 m-2">
                <img src="src/img/logo/centangBiru.png" alt="#" width={25} />
                Jakarta Timur
      ...
      <section id="menuKebutuhan" className="pt-10">
        <div className="container">
          ...
          <div id="gridButton" className="my-4 grid grid-cols-5 gap-4">
            <button
              className="h-14 p-2 bg-gradient-to-r from-yellow-500 to-yellow-400 rounded-lg text-white font-semibold"
              onClick={() => setActiveComponent("peralatanMasak")}
            >
              Peralatan Masak
            </button>
            <button
              className="h-14 p-2 bg-gradient-to-r from-green-500 to-green-400 rounded-lg text-white font-semibold"
              onClick={() => setActiveComponent("minuman")}
            >
              Minuman
            </button>
      ...
      <footer id="footer" className="pt-10">
        ...
        <p className="text-center text-sm text-slate-400 py-2">
          ©2024,Cloning Tokopaedi By Maskod
        </p>
      </footer>
      {/* Footer end */}
    </>
