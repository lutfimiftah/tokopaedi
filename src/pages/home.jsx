...
const Home = () => {
  ...
  return (
    <>
  {/* navbar start */}
  <header id="navbar" className="flex flex-wrap border sticky top-0 z-50 bg-white">
      <div className="flex items-center justify-between w-full px-4">
        <div className="flex items-center justify-start">
          <a href="#" className="text-4xl font-semibold block py-6 text-green-500">
            tokopaedi
          </a>
        </div>
        <div className="w-full flex justify-center items-center">
          ...
          <div className="border border-green-500 rounded-lg bg-white h-10 flex items-center ml-4 w-1/2">
            <form className="flex w-full">
              ...
              <input type="text" placeholder="Search.." name="search" className="outline-none w-full rounded-lg" />
            </form>
          </div>
        </div>
      ...
      <div className="w-full flex justify-center py-1">
        {["Samsung Note 10", "Charger Mobil", "Samsung A73", "Pull Up Bar", "HDD 1tb", "XBOX series X"].map((item, index) => (
          <p key={index} className="text-sm text-slate-400 px-1 hover:text-green-600 cursor-pointer">
            {item}
          </p>
        ))}
      </div>
  ...
  <section id='menuKebutuhan' className="pt-10">
    <div className="container">
      ...
      <div id='gridButton' className="my-4 grid grid-cols-5 gap-4">
        <button className="h-14 p-2 bg-gradient-to-r from-yellow-500 to-yellow-400 rounded-lg text-white font-semibold" onClick={() => setActiveComponent("peralatanMasak")} >
          Peralatan Masak
        </button>
        <button className="h-14 p-2 bg-gradient-to-r from-green-500 to-green-400 rounded-lg text-white font-semibold" onClick={() => setActiveComponent("minuman")}>
          Minuman
        </button>
